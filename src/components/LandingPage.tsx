    ...
    <div className="fixed inset-0 z-50 blur-background flex items-center justify-center px-4">
      ...
      <div className="text-center z-10 w-full max-w-lg">
        ...
        <div className="mb-8 flex flex-col items-center">
          ...
          />
          <p className="text-lg sm:text-xl text-white font-rajdhani mb-6">click to enter 🐱</p>
        </div>
        
        <Button
          onClick={onEnter}
          size="default"
          className="bg-transparent text-white border border-white/30 hover:bg-white/10 hover:border-white text-base sm:text-lg px-6 sm:px-8 py-3 sm:py-4 transition-all duration-500 hover:scale-105 font-orbitron w-full sm:w-auto opacity-0 pointer-events-none"
        >
          Enter
        </Button>
